...
$ sudo curl -L -o /usr/local/bin/cstore https://github.com/turnerlabs/cstore/releases/download/v3.4.0-alpha/cstore_darwin_amd64 && sudo chmod +x /usr/local/bin/cstore
